...
--
-- Name: i18n_keys; Type: TABLE; Schema: core; Owner: -
--
...
--
-- Name: i18n_translations; Type: TABLE; Schema: core; Owner: -
--
...
--
-- Name: i18n_keys i18n_keys_pkey; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.i18n_keys
    ADD CONSTRAINT i18n_keys_pkey PRIMARY KEY (key);


--
-- Name: i18n_translations i18n_translations_pkey; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.i18n_translations
    ADD CONSTRAINT i18n_translations_pkey PRIMARY KEY (key, language_code);
...
CREATE UNIQUE INDEX ux_languages_default ON core.languages USING btree (is_default) WHERE (is_default = true);
...
--
-- Name: i18n_translations i18n_translations_key_fkey; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.i18n_translations
    ADD CONSTRAINT i18n_translations_key_fkey FOREIGN KEY (key) REFERENCES core.i18n_keys(key) ON DELETE CASCADE;


--
-- Name: i18n_translations i18n_translations_language_code_fkey; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.i18n_translations
    ADD CONSTRAINT i18n_translations_language_code_fkey FOREIGN KEY (language_code) REFERENCES core.languages(code) ON DELETE CASCADE;
